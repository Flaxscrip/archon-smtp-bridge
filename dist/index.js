...
import { ReplyPoller } from './reply-poller.js';
 ...
 */
async function processInbound(email, recipient, messageId) {
    ...
    try {
        const result = await dmailSender.processEmail(email, [did], record, record.reply_token || undefined, record.thread_id || undefined);
        if (result) {
